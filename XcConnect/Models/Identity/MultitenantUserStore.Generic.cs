...
namespace Gextion.CRM.Models.Identity
{
    ...
    /// <typeparam name="TTenantKey">The type of <see cref="IMultitenantUser{TKey, TTenantKey}.CompanyId"/> for a user.</typeparam>
        ...
        where TUserClaim : IdentityUserClaim<TKey>, new()
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IMultitenantUser{TKey, TTenantKey}.CompanyId"/> to be used in queries.
        /// </summary>
        ...
        {
            //ThrowIfInvalid();
            //return GetUserAggregateAsync(u => u.UserName == userName && u.CompanyId.Equals(CompanyId));
        ...
        {
            //ThrowIfInvalid();
            //return GetUserAggregateAsync(u => u.Email.ToUpper() == email.ToUpper() && u.CompanyId.Equals(CompanyId));
        ...
        private void ThrowIfInvalid()
        {
            ...
            if (EqualityComparer<TTenantKey>.Default.Equals(CompanyId, default(TTenantKey)))
                throw new InvalidOperationException("The Company Id has not been set.");
        }
    }
}
